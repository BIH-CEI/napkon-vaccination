...
* valueCodeableConcept.coding.system.extension contains $ext-data-absent-reason named dataAbsentReason 0..1 MS
* valueCodeableConcept.coding.code.extension contains $ext-data-absent-reason named dataAbsentReason 0..1 MS
...
* identifier[analyseBefundCode].assigner.display = "not-applicable"
* status = #final
* valueCodeableConcept.coding.system.extension[dataAbsentReason].valueCode = $cs-data-absent-reason#not-applicable
* valueCodeableConcept.coding.code.extension[dataAbsentReason].valueCode = $cs-data-absent-reason#not-applicable
* valueCodeableConcept.text = "B.1.1.529"
* subject = Reference(ExamplePatient)
* effectiveDateTime = "2021-01-01T00:00:00+00:00" // required for sushi 2.1.1 (error is raised otherwise), but not for actual profile ..
* effectiveDateTime.extension[dataAbsentReason].valueCode = $cs-data-absent-reason#unknown
